...
def build_weight_matrix(features1: DataFrame, features2: DataFrame, distance: str="cosine", threshold: float=0.0, sparsity: float=0.25) -> Tuple[AddrIndex, AddrIndex, csr_matrix]:
    """
