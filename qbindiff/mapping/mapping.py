...
class Mapping:
    ...
    """
    def __init__(self, mapping: ExtendedMapping, unmatched: Tuple[Set[Item], Set[Item]]):
    ...
    def add_match(self, item1: Item, item2: Item, similarity: float = None, squares: int = None) -> None:
        """
